...
public class ListadoProveedores extends TabItem {

    public static PagingLoader<PagingLoadResult<BaseModel>> loader;
    private final ProveedorServiceAsync proveedorService = GWT.create(ProveedorService.class);
    ...
    public ListadoProveedores() {
        ...
        botonBorrar.addSelectionListener(new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                ...
                if (lista.size() > 0) {
                            ...
                            new Listener<MessageBoxEvent>() {
                                ...
                                public void handleEvent(MessageBoxEvent be) {
                                    if (be.getButtonClicked().getText().equalsIgnoreCase("yes")) {
                                        ...
                                        proveedorService.borrarProveedores(ids, new AsyncCallback<Void>() {
                    ...
                    MessageBox.alert("Atención", "Debe seleccionar al menos un proveedor", null);
                }
            }
        });
        ...
        columna.setId("idProveedor");
        columna.setHeader("idProveedor");
        ...
        proxy = new RpcProxy<PagingLoadResult<BaseModel>>() {
            ...
            public void load(Object loadConfig, AsyncCallback<PagingLoadResult<BaseModel>> callback) {
               proveedorService.listarProveedores((PagingLoadConfig) loadConfig, callback);
            }
        };
        ...
        store.addStoreListener(new StoreListener<BaseModel>() {
            ...
            public void storeUpdate(final StoreEvent<BaseModel> se) {
                ...
                if(rucRecord.trim().isEmpty()) {
                    MessageBox.alert("Atención", "R.U.C. del proveedor no pueder ser vacío.", null);
                    loader.load();
                    return;
                }
                RootPanel.get("loading").setVisible(true);
                proveedorService.actualizarProveedor((Integer) r.getModel().get("id"),
                        nombreRecord,
                        rucRecord,
